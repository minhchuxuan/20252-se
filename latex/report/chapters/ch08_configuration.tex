...
C5 & Test suite
   & The shared test fixtures and the automated test modules --- sixty-six functional cases plus three open-defect cases (known failures)
   & QA lead \\[4pt]
...
M3 --- Implementation
  ...
  & All sixty-six functional tests pass (three open-defect tests remain failing, marking known bugs); the demonstration seeds twenty-one days of data and the application runs end-to-end \\[6pt]
...
\begin{description}[leftmargin=1.6cm, style=nextline]
  \item[Integration line]
    ...
    the full suite of sixty-six functional tests (the three open-defect tests are
...
The sixty-six functional tests must pass on the branch before
