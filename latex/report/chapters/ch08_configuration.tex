...
C5 & Test suite
   & The shared test fixtures and the nine automated test modules comprising sixty-seven cases
   & QA lead \\[4pt]
...
M3 --- Implementation
  ...
  & All sixty-seven automated tests pass; the demonstration seeds twenty-one days of data and the application runs end-to-end \\[6pt]
...
\begin{description}[leftmargin=1.6cm, style=nextline]
  \item[Integration line]
    ...
    the full suite of sixty-seven automated tests. Changes are never applied to it
...
The full automated test suite of sixty-seven cases must pass on the branch before
