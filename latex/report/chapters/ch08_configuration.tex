...
organised around the five canonical SCM tasks drawn from \textbf{IEEE~828} and
...
C5 & Test suite
   & The shared test fixtures and the eight automated test modules comprising fifty-four cases
   & QA lead \\[4pt]
...
M3 --- Implementation
  ...
  & All fifty-four automated tests pass; the demonstration seeds twenty-one days of data and the application runs end-to-end \\[6pt]
...
\begin{description}[leftmargin=1.6cm, style=nextline]
  \item[Integration line]
    ...
    the full suite of fifty-four automated tests. Changes are never applied to it
...
The full automated test suite of fifty-four cases must pass on the branch before
