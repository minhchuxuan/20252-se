...
C5 & Test suite
   & The shared test fixtures and the nine automated test modules comprising sixty-four cases
   & QA lead \\[4pt]
...
M3 --- Implementation
  ...
  & All sixty-four automated tests pass; the demonstration seeds twenty-one days of data and the application runs end-to-end \\[6pt]
...
\begin{description}[leftmargin=1.6cm, style=nextline]
  \item[Integration line]
    ...
    the full suite of sixty-four automated tests. Changes are never applied to it
...
The full automated test suite of sixty-four cases must pass on the branch before
