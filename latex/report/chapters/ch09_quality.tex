...
\textbf{61 automated tests} and concludes with a requirements-to-tests
...
(IEEE 610.12), \emph{software quality} is the degree to which a system meets
...
The automated suite comprises \textbf{61 tests}. It runs in-process against the
...
project organises its tests into eight such suites, each devoted to one
...
Table~\ref{tab:levels} summarises how the 61 tests distribute across the four
levels.

\begin{table}[htbp]
\centering
\caption{Distribution of the 61 automated tests across V-model levels.}
\label{tab:levels}
...
The full suite passes: \textbf{61 tests, 61 passed}. Because tests are derived
