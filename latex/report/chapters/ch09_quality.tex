...
\textbf{64 automated tests} and concludes with a requirements-to-tests
...
The automated suite comprises \textbf{64 tests}. It runs in-process against the
...
Table~\ref{tab:levels} summarises how the 64 tests distribute across the four
levels.

\begin{table}[htbp]
\centering
\caption{Distribution of the 64 automated tests across V-model levels.}
\label{tab:levels}
...
The full suite passes: \textbf{64 tests, 64 passed}. Because tests are derived
