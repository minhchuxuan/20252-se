...
Each increment closed with automated regression testing (69 tests, 66 passing) and a
...
\begin{longtable}{@{}p{0.6cm} p{3.8cm} p{7.6cm}@{}}
  ...
  9.1 & Unit and integration test suite
      & Automated suite covers all REQ-4.x items; the 66 functional tests pass on a clean checkout (3 open-defect tests still fail, marking known bugs). \\[2pt]
