...
\subsection{People}
The development team consists of six undergraduate students, each taking on
...
Each increment closed with automated regression testing (64 test cases) and a
...
\begin{longtable}{@{}p{0.6cm} p{3.8cm} p{7.6cm}@{}}
  ...
  9.1 & Unit and integration test suite
      & Automated suite covers all REQ-4.x items; all 64 test cases pass on a clean checkout. \\[2pt]
