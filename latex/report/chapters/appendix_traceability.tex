...
drift) are centralised in the system configuration module. The full suite is \textbf{69 automated tests
--- 66 passing}, with 3 negative open-defect tests that currently fail, marking known bugs.
