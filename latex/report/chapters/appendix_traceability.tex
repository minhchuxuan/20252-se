...
drift) are centralised in the system configuration module. The full suite is \textbf{70 automated tests
--- 67 passing}, with 3 negative open-defect tests that currently fail, marking known bugs.
